         ...
         <table class="datatable table card-table">
            <thead>
                <tr>
                    <th>Nama</th>
                    <th>Status</th>
                    <th>Waktu Start & Prkiraan Sampai</th>  
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="badge badge-<?php echo ($vechicle_status_arr['t_trip_status']=='Completed') ? 'success':'danger' ?>"><?php echo ($vechicle_status_arr['t_trip_status']=='Completed') ? 'Idle':'In Trip' ?></span></td>
                    <td><?php echo output($vechicle_status_arr['date']); ?></td>  </tr>
                <?php  }   }   ?>
        </table>
    </div>
   </div>
